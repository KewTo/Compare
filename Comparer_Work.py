...
# There is a folder filed with XSEM data 

path = r"Y:\Resist_screening_summaries\X-Section"

# Set up for the list of files dates
...
# Finding all folders that are between Jan 01 2022 and Sept 11 2022 and adding to a list
